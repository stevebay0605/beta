          ...
          <div className="space-y-2">
            ...
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                ...
                className="w-4 h-4 text-[#0055A4] accent-[#0055A4]"
              />
              <span className="text-slate-700 text-sm">En ligne</span>
            </label>
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                type="radio"
                ...
                className="w-4 h-4 text-[#0055A4] accent-[#0055A4]"
              />
              <span className="text-slate-700 text-sm">Présentiel</span>
            </label>
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                type="radio"
                ...
                className="w-4 h-4 text-[#0055A4] accent-[#0055A4]"
              />
              <span className="text-slate-700 text-sm">Hybride</span>
            </label>
          </div>
        </div>
          ...
          <div className="space-y-2">
            ...
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                ...
                className="w-4 h-4 text-[#0055A4] accent-[#0055A4]"
              />
              <span className="text-slate-700 text-sm">Payant</span>
            </label>
          </div>
        </div>
